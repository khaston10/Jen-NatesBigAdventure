...
public class GroomsmanCont : MonoBehaviour
{
    /* 
    The groomsman will have 2 different modes.
    ...
    */
    ...
    void Start()
    {
        ...
        if (idle == false) anim.Play("GroomWalkRight");
    }
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if(movingRight && anim.GetCurrentAnimatorStateInfo(0).IsName("GroomWalkLeft"))
            {
                anim.Play("GroomWalkRight");
            }

            else if (movingRight == false && anim.GetCurrentAnimatorStateInfo(0).IsName("GroomWalkRight"))
            {
                anim.Play("GroomWalkLeft");
            }
