...
public class SlugCont : MonoBehaviour
{
    /* 
   ...
   */
    ...
    void Update()
    {
        ...
        if (movingRight && anim.GetCurrentAnimatorStateInfo(0).IsName("Left"))
        {
            anim.Play("Right");
        }

        else if (movingRight == false && anim.GetCurrentAnimatorStateInfo(0).IsName("Right"))
        {
            anim.Play("Left");
        }
